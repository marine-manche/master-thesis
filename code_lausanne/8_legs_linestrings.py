...
def main():
    ...
    for c in string.ascii_uppercase:
        os.system("git lfs pull -I 'pickles/linestrings_use_lausanne/linestrings_" + c + ".geojson'")
        linestrings = gpd.read_file("../pickles/linestrings_use_lausanne/linestrings_" + c + ".geojson")
    ...
    # Save DataFrame
    pkl.dump(legs_linestrings, open("../pickles/legs_use_lausanne.pkl", "wb"))
